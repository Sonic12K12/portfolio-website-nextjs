    ...
    <main>
      <article className="max-w-3xl mx-auto">
        ...
        <p>
          ...
          tool, aiming to inform players and raise awareness about the
          real-world challenges of future food security.
        </p>
        ...
        <ul className="list-disc list-outside ml-6 space-y-4 text-text-main">
          ...
          <li>
            <strong>Resource Management:</strong> Players must place
            compartments efficiently and invest in research to sustain the
            nutritional needs of the growing population.
          </li>
          <li>
            <strong>Real-World Science:</strong> Designed to showcase the
            research of <em>food4future</em>, core gameplay elements are
            directly based on actual research for sustainable food production in
            urban environments.
          </li>
        </ul>
        ...
        <p className="mb-4">
          I focused on bridging the gap between scientific research and the
          player experience, both visually and mechanically. My core
        ...
        <ul className="list-disc list-outside ml-6 space-y-4 text-text-main">
          <li>
            ...
            remained scientifically accurate and fully aligned with the
            futuristic scenario they had envisioned.
          </li>
          <li>
            <strong>3D Compartment Modeling:</strong> Using Autodesk Maya, I
            modeled the specialized cultivation compartments. These 3D models
            were designed to be showcased as rotating elements within the
            game&apos;s menus, requiring them to be highly detailed yet easily
            readable on mobile screens.
          </li>
          <li>
            <strong>In-Game Copywriting:</strong> I wrote the in-game
            descriptions for the compartments and resources. Since I had
            conducted most of the scientific research, I took on the
            responsibility of translating those complex concepts into
            accessible, engaging information for the players.
          </li>
          <li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <p>
            A major highlight of the development process was pitching the game
            at the food4future summer festival at Therme Bad Saarow in July
            2025. I had the opportunity to deliver the main presentation,
            introducing our core concepts and mechanics to an audience of
            stakeholders and domain experts. Following the talk, we showcased a
            playable prototype at our booth, gathering invaluable feedback. This
            direct exchange heavily influenced our final polish leading up to
            the official HTW IMI Showtime exhibition.
          </p>
        ...
        <p>
          Working on BioTopia was a great experience in balancing technical
          limits with an engaging user experience. Coming up with a solid game
          concept from scratch was a challenge in itself, especially since we
          had to turn real research from food4future into intuitive gameplay
          mechanics while also keeping our 3D assets optimized for mobile
          devices. But beyond the tech side, it was just incredibly cool to go
          through a full production cycle—from the first brainstorming session
          to actually playing a real, finished game. Our team effort really paid
          off with a <strong>final grade of 1.3</strong>, and it showed me how
          well serious games can work to make science accessible and engaging.
        </p>
